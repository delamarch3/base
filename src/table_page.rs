...
// pub async fn read_tuple(page: &Page, slot_offset: u64, schema: &[Type]) -> Tuple {
...
// pub async fn write_tuple(page: &Page, tuple: &Tuple) -> RelationID {
...
//         let pc: PageCache<4> = PageCache::new(disk, replacer, 0);
...
//         let page_0 = pc.new_page().await.expect("should return page 0");
//         let page_0_id = 0;
...
//         pc.flush_page(page_0_id).await;

//         let page_0 = pc.fetch_page(tid_1.0).await.expect("should return page 0");
//         let page_0_tuples = [
